...
class MenuListAdapter extends RecyclerView.Adapter<MenuListAdapter.MyViewHolder> implements Serializable {
    ...
    public MenuListAdapter(List<StringIntegerPair> moviesList) {
