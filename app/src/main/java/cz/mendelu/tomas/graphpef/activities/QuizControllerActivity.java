...
public class QuizControllerActivity extends AppCompatActivity implements Serializable {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        questionList = dbHelper.getUnlockedQuestions();
            ...
            public void onClick(View v) {
                ...
                if(!answered){
                    ...
                    if (quizAnswer1.isChecked() || quizAnswer2.isChecked() || quizAnswer3.isChecked() || quizAnswer4.isChecked()){
                        ...
                        Toast.makeText(QuizControllerActivity.this, "Select answer", Toast.LENGTH_SHORT).show();
                    }
                }else{
                    showNextQuestion();
                }
    ...
    private void checkAnswer(){
        ...
        if (currentQuestion.getCorrectAnswerId() == answerID){
            ...
            if (currentQuestion.isAnswered()) {
                ...
                dbHelper.addQuestionAnswered(currentQuestion.getFirestoreID());
                score += 5;
            }
            ...
            if (questionCounter < questionsInCategory){
                ...
                Toast.makeText(QuizControllerActivity.this, getResources().getString(R.string.quizAnsweredAllQuestions),
    ...
    public void onBackPressed() {
        ...
        if (lastBackPressed + 2000 > System.currentTimeMillis()) {
            ...
            Toast.makeText(QuizControllerActivity.this, getResources().getString(R.string.quizTwoBackpress),
